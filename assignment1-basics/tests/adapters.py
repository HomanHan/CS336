...
def run_embedding(
    ...
    """
    model = Embedding.Embedding(vocab_size, d_model)
...
def run_swiglu(
    ...
    model = PositionWiseFFN.PositionWiseFFN(d_model, d_ff)
...
def run_scaled_dot_product_attention(
    ...
    """
    return SDPA.scaled_dot_product_attention(Q, K, V, mask)
...
def run_transformer_lm(
    ...
    Args:
        ...
        rope_theta (float): The RoPE Θ ($Theta$) parameter.
        weights (dict[str, Tensor]):
...
def run_silu(in_features: Float[Tensor, " ..."]) -> Float[Tensor, " ..."]:
    ...
    """
    return PositionWiseFFN.SwishLU(in_features)
...
def run_softmax(in_features: Float[Tensor, " ..."], dim: int) -> Float[Tensor, " ..."]:
    ...
    """
    return SDPA.softmax(in_features, dim=dim)
...
def run_gradient_clipping(
    ...
    """
    return AdamW.gradient_clipping(parameters, max_l2_norm)
...
def run_get_lr_cosine_schedule(
    ...
    """
    return AdamW.learning_rate_schedule(
